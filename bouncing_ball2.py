...
while running:
  ...
  pygame.draw.line(display, (0,0,0),(0,disp_h - 50),(disp_w,disp_h - 50),9) #el ancho del segmento dibujado no coincide con el ancho del segmento en pymunk hay q poner un poco mas en pygame
  pygame.display.flip()
  clock.tick(FPS)
