...
image = pygame.transform.scale(image,(ball_radius*2,ball_radius*2 )) # Dos veces el radio
...
while running:
  ...
  display.blit(image, (int(body.position.x)-ball_radius, disp_h - int(body.position.y)-ball_radius)) # Hay que restar el ball_radius porque la imagen empieza arriba a la derecha
