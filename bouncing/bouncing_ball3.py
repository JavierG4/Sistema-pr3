...
segment_shape2 = pymunk.Segment(segment_body, (disp_w - 50,0),(disp_w - 50,800),5)
...
while running:
  ...
  pygame.draw.line(display, (0,0,0),(disp_w - 50,0),(disp_w - 50,disp_h),9)
  pygame.display.flip()
  clock.tick(FPS)
