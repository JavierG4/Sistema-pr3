...
# Las cajas y el circulo se ponen arriba porque el draw options invierte la y
body = pymunk.Body()
body.position = (20, 420)  # Posición inicial en el centro
circle = pymunk.Circle(body, 20)
circle.density = 1
circle.friction = 0.3 # Si tiene 0 se mueve sola
...
while running:
  ...
  if keys[pygame.K_SPACE]:
    ...
    impulse = 100000 * Vec2d(1,-1) # El 100000 depende de los fps
